...
//    var aux = new Date(parseInt(date.substr(6, 13)));
...
$(document).ready(function () {
    ...
    //});
    ////$('#reportrange1').data('daterangepicker').setOptions(optionSet1, cb1);
    ...
    var optionSet2 = {
        ...
        startDate: moment().subtract(2190, 'days'),
        endDate: moment(),
        opens: 'left',
        ranges: {
            'Today': [moment(), moment()],
    ...
    $('#reportrange2 span').html(moment().subtract(2190, 'days').format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
